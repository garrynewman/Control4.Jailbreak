namespace  Garry.Control4.Jailbreak
{
	partial class Backup
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Size = new System.Drawing.Size(390, 207);
			...
			this.label1.Text = "Controller Certificate Backup";
			// 
			// button1
			// 
			...
			this.button1.Image = global:: Garry.Control4.Jailbreak.Properties.Resources.download;
			...
			this.button1.Click += new System.EventHandler(this.MakeABackupOfTheCertificate);
			// 
			// BackupAndRestore
			// 
